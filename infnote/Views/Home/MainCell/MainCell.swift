...
class MainCell: UITableViewCell {
    ...
    func prepareViews() {
        ...
        avatarView.snp.remakeConstraints { make in
            ...
            make.top.equalToSuperview().offset(ViewConst.margin / 2)
            make.height.equalTo(40)
            make.width.equalTo(40)
        }
        
        nicknameLabel.text = "Vergil Choi"
        nicknameLabel.font = UIFont(name: DEFAULT_FONT_REGULAR, size: 16)
        ...
        categoryLabel.font = UIFont(name: DEFAULT_FONT_REGULAR, size: 14)
        ...
        titleLabel.snp.remakeConstraints { make in
            make.left.equalToSuperview().offset(ViewConst.margin)
            make.right.equalToSuperview().offset(-ViewConst.margin)
            make.top.equalTo(avatarView.snp.bottom).offset(ViewConst.margin / 2)
        }
        ...
        imageStackView.snp.remakeConstraints { make in
            make.left.equalToSuperview().offset(ViewConst.margin)
            make.right.equalToSuperview().offset(-ViewConst.margin)
            make.top.equalTo(contentLabel.snp.bottom).offset(ViewConst.margin / 2)
        ...
        timeLabel.snp.remakeConstraints { make in
            ...
            make.top.equalTo(imageStackView.snp.bottom).offset(ViewConst.margin / 2)
        }
